...
import com.streaming.model.CarouselItemsDashboardModel;
...
/**
 * The base model implementation for the CarouselItemsDashboard service. Represents a row in the &quot;STGCarouselItemsDashboard&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 ...
 */
@JSON(strict = true)
public class CarouselItemsDashboardModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "STGCarouselItemsDashboard";
	...
	public static final String TABLE_SQL_CREATE =
		"create table STGCarouselItemsDashboard (mvccVersion LONG default 0 not null,uuid_ VARCHAR(75) null,externalReferenceCode VARCHAR(75) null,categoryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,category VARCHAR(75) null,colorTheme VARCHAR(75) null,instanceCategoryFk LONG,priority VARCHAR(75) null,title VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP =
		"drop table STGCarouselItemsDashboard";

	public static final String ORDER_BY_JPQL =
		" ORDER BY carouselItemsDashboard.category ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY STGCarouselItemsDashboard.category ASC";
	 ...
	 */
	@Deprecated
	public static final long CATEGORY_COLUMN_BITMASK = 32L;
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"categoryId",
			(BiConsumer<CarouselItemsDashboard, Long>)
				CarouselItemsDashboard::setCategoryId);
		attributeGetterFunctions.put(
	...
	public Object clone() {
		...
		carouselItemsDashboardImpl.setCategoryId(getCategoryId());
	...
	public CarouselItemsDashboard cloneWithOriginalValues() {
		...
		carouselItemsDashboardImpl.setCategoryId(
			this.<Long>getColumnOriginalValue("categoryId"));
	...
	public int compareTo(CarouselItemsDashboard carouselItemsDashboard) {
		...
		value = getCategory().compareTo(carouselItemsDashboard.getCategory());
	...
	public CacheModel<CarouselItemsDashboard> toCacheModel() {
		...
		carouselItemsDashboardCacheModel.categoryId = getCategoryId();

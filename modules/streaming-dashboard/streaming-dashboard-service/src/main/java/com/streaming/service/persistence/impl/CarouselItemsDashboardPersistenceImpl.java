...
public class CarouselItemsDashboardPersistenceImpl
	...
	public List<CarouselItemsDashboard> findByGetCarouselItems(
		...
		return findByGetCarouselItems(
			companyId, groupId, streamingId, QueryUtil.ALL_POS,
	...
	public List<CarouselItemsDashboard> findByGetCarouselItems(
		...
		return findByGetCarouselItems(
			companyId, groupId, streamingId, start, end, null);
	}
	...
	public List<CarouselItemsDashboard> findByGetCarouselItems(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {companyId, groupId, streamingId};
			}
		}
		else if (useFinderCache) {
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CarouselItemsDashboard carouselItemsDashboard : list) {
					if ((companyId != carouselItemsDashboard.getCompanyId()) ||
						(groupId != carouselItemsDashboard.getGroupId()) ||
						(streamingId !=
							carouselItemsDashboard.getStreamingId())) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GETCAROUSELITEMS_COMPANYID_2);

			sb.append(_FINDER_COLUMN_GETCAROUSELITEMS_GROUPID_2);

			sb.append(_FINDER_COLUMN_GETCAROUSELITEMS_STREAMINGID_2);
	...
	public CarouselItemsDashboard fetchByGetCarouselItems_First(
		...
		List<CarouselItemsDashboard> list = findByGetCarouselItems(
			companyId, groupId, streamingId, 0, 1, orderByComparator);
	...
	public CarouselItemsDashboard fetchByGetCarouselItems_Last(
		...
		int count = countByGetCarouselItems(companyId, groupId, streamingId);
		...
		List<CarouselItemsDashboard> list = findByGetCarouselItems(
			companyId, groupId, streamingId, count - 1, count,
			orderByComparator);
	 ...
	 */
	@Override
	public void removeByGetCarouselItems(
		long companyId, long groupId, long streamingId) {
	 ...
	 */
	@Override
	public int countByGetCarouselItems(
		long companyId, long groupId, long streamingId) {

		FinderPath finderPath = _finderPathCountByGetCarouselItems;

		Object[] finderArgs = new Object[] {companyId, groupId, streamingId};
	...
	private static final String _FINDER_COLUMN_GETCAROUSELITEMS_COMPANYID_2 =
		"carouselItemsDashboard.companyId = ? AND ";

	private static final String _FINDER_COLUMN_GETCAROUSELITEMS_GROUPID_2 =
		"carouselItemsDashboard.groupId = ? AND ";

	private static final String _FINDER_COLUMN_GETCAROUSELITEMS_STREAMINGID_2 =
		"carouselItemsDashboard.streamingId = ?";

	private FinderPath _finderPathFetchByGetCarouselItem;
	private FinderPath _finderPathCountByGetCarouselItem;
	 ...
	 */
	@Override
	public CarouselItemsDashboard findByGetCarouselItem(
			long companyId, long groupId, long streamingId)
		throws NoSuchCarouselItemsDashboardException {

		CarouselItemsDashboard carouselItemsDashboard = fetchByGetCarouselItem(
	 ...
	 */
	@Override
	public CarouselItemsDashboard fetchByGetCarouselItem(
		long companyId, long groupId, long streamingId) {

		return fetchByGetCarouselItem(companyId, groupId, streamingId, true);
	}
	...
	public CarouselItemsDashboard fetchByGetCarouselItem(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByGetCarouselItem, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_GETCAROUSELITEM_COMPANYID_2);

			sb.append(_FINDER_COLUMN_GETCAROUSELITEM_GROUPID_2);

			sb.append(_FINDER_COLUMN_GETCAROUSELITEM_STREAMINGID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByGetCarouselItem, finderArgs,
							list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"CarouselItemsDashboardPersistenceImpl.fetchByGetCarouselItem(long, long, long, boolean) with parameters (" +
	 ...
	 */
	@Override
	public CarouselItemsDashboard removeByGetCarouselItem(
			long companyId, long groupId, long streamingId)
		throws NoSuchCarouselItemsDashboardException {

		CarouselItemsDashboard carouselItemsDashboard = findByGetCarouselItem(
			companyId, groupId, streamingId);
	 ...
	 */
	@Override
	public int countByGetCarouselItem(
		long companyId, long groupId, long streamingId) {

		FinderPath finderPath = _finderPathCountByGetCarouselItem;
	...
	private static final String _FINDER_COLUMN_GETCAROUSELITEM_COMPANYID_2 =
		"carouselItemsDashboard.companyId = ? AND ";

	private static final String _FINDER_COLUMN_GETCAROUSELITEM_GROUPID_2 =
		"carouselItemsDashboard.groupId = ? AND ";

	private static final String _FINDER_COLUMN_GETCAROUSELITEM_STREAMINGID_2 =
		"carouselItemsDashboard.streamingId = ?";
	...
	public void cacheResult(CarouselItemsDashboard carouselItemsDashboard) {
		...
		finderCache.putResult(
			_finderPathFetchByGetCarouselItem,
			new Object[] {
				carouselItemsDashboard.getCompanyId(),
				carouselItemsDashboard.getGroupId(),
				carouselItemsDashboard.getStreamingId()
			},
			carouselItemsDashboard);
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
			carouselItemsDashboardModelImpl.getCompanyId(),
			carouselItemsDashboardModelImpl.getGroupId(),
			carouselItemsDashboardModelImpl.getStreamingId()
		};

		finderCache.putResult(
			_finderPathCountByGetCarouselItem, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByGetCarouselItem, args,
	 ...
	 */
	@Override
	public CarouselItemsDashboard create(long streamingId) {
		CarouselItemsDashboard carouselItemsDashboard =
				new CarouselItemsDashboard();

		carouselItemsDashboard.setNew(true);
		carouselItemsDashboard.setPrimaryKey(streamingId);
	 ...
	 */
	@Override
	public CarouselItemsDashboard remove(long streamingId)
		throws NoSuchCarouselItemsDashboardException {

		return remove((Serializable)streamingId);
	}
	...
	public CarouselItemsDashboard updateImpl(
		...
		if (Validator.isNull(
			...
			if (isNew) {
				...
				if ((ercCarouselItemsDashboard != null) &&
					(carouselItemsDashboard.getStreamingId() !=
						ercCarouselItemsDashboard.getStreamingId())) {
	 ...
	 */
	@Override
	public CarouselItemsDashboard findByPrimaryKey(long streamingId)
		throws NoSuchCarouselItemsDashboardException {

		return findByPrimaryKey((Serializable)streamingId);
	}
	 ...
	 */
	@Override
	public CarouselItemsDashboard fetchByPrimaryKey(long streamingId) {
		return fetchByPrimaryKey((Serializable)streamingId);
	}
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByGetCarouselItems = new FinderPath(
			...
			new String[] {"companyId", "groupId", "streamingId"}, true);
		...
		_finderPathCountByGetCarouselItems = new FinderPath(
			...
			new String[] {"companyId", "groupId", "streamingId"}, false);

		_finderPathFetchByGetCarouselItem = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByGetCarouselItem",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"companyId", "groupId", "streamingId"}, true);

		_finderPathCountByGetCarouselItem = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByGetCarouselItem",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"companyId", "groupId", "streamingId"}, false);

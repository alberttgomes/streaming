...
/**
 * Provides the base implementation for the carousel items dashboard remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.streaming.service.impl.CarouselItemsDashboardServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.streaming.service.impl.CarouselItemsDashboardServiceImpl
 * @generated
 */
public abstract class CarouselItemsDashboardServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CarouselItemsDashboardService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CarouselItemsDashboardServiceUtil</code>.
	 */
	@Deactivate
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				CarouselItemsDashboardServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, carouselItemsDashboardService);
		}

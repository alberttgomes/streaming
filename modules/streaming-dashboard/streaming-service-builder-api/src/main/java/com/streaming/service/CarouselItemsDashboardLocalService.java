...
public interface CarouselItemsDashboardLocalService
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CarouselItemsDashboard deleteCarouselItemsDashboard(long streamingId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CarouselItemsDashboard fetchCarouselItemsDashboard(long streamingId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CarouselItemsDashboard getCarouselItemsDashboard(long streamingId)
		throws PortalException;
